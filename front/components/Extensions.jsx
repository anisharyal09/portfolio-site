...
export default function Extensions() {
  ...
  // The high-quality YouTube thumbnail URL
  ...
  return (
    <section className="relative w-full pt-24 pb-32 flex flex-col items-center">
      {/* =========================================
          1. TOP FADE
         ========================================= */}
      <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-black/90 to-transparent z-20 pointer-events-none"></div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col items-center">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          {/* NEW, SIMPLIFIED SUPPORTING TEXT */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 w-full max-w-6xl mt-8">
          ...
          {/* === LEFT/CENTER: YOUTUBE & VIDEO CONTENT (2/3 width on desktop) === */}
            ...
            >
              ...
              <div className="absolute bottom-4 right-4 flex gap-2 z-20">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                  <div className="w-20 h-20 bg-red-600/90 rounded-full flex items-center justify-center scale-75 group-hover:scale-100 transition-transform duration-300">
                    <Play size={32} className="text-white fill-white ml-1" />
                  </div>
                </div>

                {/* Original Buttons - Fade out slightly to emphasize play button */}
          ...
          {/* === RIGHT: PERSONAL INTERESTS (1/3 width on desktop) === */}
          <div
